...
PROMPTS_PATH = Path("dataset/test_pregnancy.jsonl")
OUT_PATH     = Path("dataset/test_pregnancy_samples.jsonl")
...
MAX_SAMPLES    = 10   # Maximum number of questions to use (set to None to use all)
MAX_NEW_TOKENS = 256     # Max new tokens generated by MMT/Teacher
